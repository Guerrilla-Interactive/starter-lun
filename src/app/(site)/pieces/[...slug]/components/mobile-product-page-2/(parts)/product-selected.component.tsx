...
export const ProductSelected: React.FC<ProductSelectedProps> = ({
  ...
  return (
    <FlexRow className="place-self-center text-xs text-lunnheim-dark-olive">
      <GapX gap-x-2>
        <FlexCol>
        ...
        {/* <FlexCol className="h-5 w-5 rounded-full border border-gray-200" style={{ backgroundColor: variantColor?.hex }}></FlexCol> */}
      </GapX>
    </FlexRow>
  )
}
